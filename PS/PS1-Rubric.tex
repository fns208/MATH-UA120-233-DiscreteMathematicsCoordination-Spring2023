...
\begin{question}
   (Scheinerman, Exercise 4.2:)
    Below you will find pairs of statements $A$ and $B$. 
    For each pair, please indicate which of the following three sentences are true and which are false:
    \begin{itemize}
        \item If $A$, then $B$.
        \item If $B$, then $A$.
...
\begin{solution}
	...
	\end{eqnarray*}
	\item Let $k=k_1+k_2$. Since there exists an integer $k$ such that 
